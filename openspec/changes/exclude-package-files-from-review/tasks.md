...
- [x] Update README default file filtering documentation to describe package manifest and lock file review exclusions while clarifying that inventory may still classify them. (verification: repository evidence - `README.md` lines 103-117 document review-path package manifest and lock-file exclusions, inventory-vs-review distinction, and package-adjacent executable eligibility)
