...
- [x] Update user-facing documentation for command adapter defaults and quiet timeout behavior. (verification: integration - `rg "timeout_seconds|quiet_timeout_seconds" README.md README.ja.md` shows documentation for default `timeout_seconds` as 3600 seconds / 60 minutes and default `quiet_timeout_seconds` as 600 seconds / 10 minutes.)
